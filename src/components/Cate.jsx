  ...
  return (
    <>
      ...
      <div className="grid gap-7 grid-cols-2 md:grid-cols-3 xl:grid-cols-4 m-[2%] text-right text-lg justify-around xl:ml-[15%] xl:mr-[15%] font-rubik">
        <div className="relative md:row-span-2 md:col-span-2 shadow-md hover:shadow-md hover:shadow-gray-500">
          <img
            className="md:w-[440px] w-[240px] "
            src="public\cate_images\tiers.png"
            alt=""
            srcset=""
          />
        ...
        <div className="relative shadow-md hover:shadow-md hover:shadow-gray-500">
